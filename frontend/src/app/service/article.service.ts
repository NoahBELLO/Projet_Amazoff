...
export class ArticleService {
  ...
  // Méthode pour obtenir les articles stockés
  getStoredArticles(): any[] {
    return this.articles;
  }


  // Méthode pour stocker les articles récupérés
  fetchAndStoreArticles(): void {
    this.getArticles().subscribe(
      (data: any) => {
        this.articles = data; // Stockez les articles récupérés
