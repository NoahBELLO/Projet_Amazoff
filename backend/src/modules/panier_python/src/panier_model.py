...
#@model (code serveur)
# from articles_python.src.articles_model import ArticleModel
# from articles_python.src.articles_bdd import TableArticles
    ...
    def get_cart(self, user_id):
        try:
            ...
            for article in panier_bdd['articles']:
                ...
                article_magasin = response.json().get('rs', {})
